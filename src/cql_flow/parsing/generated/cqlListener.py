...
class cqlListener(ParseTreeListener):
    ...
    def enterQualifiedIdentifierExpression(
        self, ctx: cqlParser.QualifiedIdentifierExpressionContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#qualifiedIdentifierExpression.
    def exitQualifiedIdentifierExpression(
        self, ctx: cqlParser.QualifiedIdentifierExpressionContext
    ):
        pass
    ...
    def enterSimplePathQualifiedIdentifier(
        self, ctx: cqlParser.SimplePathQualifiedIdentifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#simplePathQualifiedIdentifier.
    def exitSimplePathQualifiedIdentifier(
        self, ctx: cqlParser.SimplePathQualifiedIdentifierContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#simplePathReferentialIdentifier.
    def enterSimplePathReferentialIdentifier(
        self, ctx: cqlParser.SimplePathReferentialIdentifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#simplePathReferentialIdentifier.
    def exitSimplePathReferentialIdentifier(
        self, ctx: cqlParser.SimplePathReferentialIdentifierContext
    ):
        pass
    ...
    def enterPluralDateTimePrecision(
        self, ctx: cqlParser.PluralDateTimePrecisionContext
    ):
        pass
    ...
    def enterSetAggregateExpressionTerm(
        self, ctx: cqlParser.SetAggregateExpressionTermContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#setAggregateExpressionTerm.
    def exitSetAggregateExpressionTerm(
        self, ctx: cqlParser.SetAggregateExpressionTermContext
    ):
        pass
    ...
    def enterDifferenceExpressionTerm(
        self, ctx: cqlParser.DifferenceExpressionTermContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#differenceExpressionTerm.
    def exitDifferenceExpressionTerm(
        self, ctx: cqlParser.DifferenceExpressionTermContext
    ):
        pass
    ...
    def enterSuccessorExpressionTerm(
        self, ctx: cqlParser.SuccessorExpressionTermContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#successorExpressionTerm.
    def exitSuccessorExpressionTerm(
        self, ctx: cqlParser.SuccessorExpressionTermContext
    ):
        pass
    ...
    def enterInvocationExpressionTerm(
        self, ctx: cqlParser.InvocationExpressionTermContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#invocationExpressionTerm.
    def exitInvocationExpressionTerm(
        self, ctx: cqlParser.InvocationExpressionTermContext
    ):
        pass
    ...
    def enterDateTimePrecisionSpecifier(
        self, ctx: cqlParser.DateTimePrecisionSpecifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#dateTimePrecisionSpecifier.
    def exitDateTimePrecisionSpecifier(
        self, ctx: cqlParser.DateTimePrecisionSpecifierContext
    ):
        pass
    ...
    def enterOffsetRelativeQualifier(
        self, ctx: cqlParser.OffsetRelativeQualifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#offsetRelativeQualifier.
    def exitOffsetRelativeQualifier(
        self, ctx: cqlParser.OffsetRelativeQualifierContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#exclusiveRelativeQualifier.
    def enterExclusiveRelativeQualifier(
        self, ctx: cqlParser.ExclusiveRelativeQualifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#exclusiveRelativeQualifier.
    def exitExclusiveRelativeQualifier(
        self, ctx: cqlParser.ExclusiveRelativeQualifierContext
    ):
        pass
    ...
    def enterConcurrentWithIntervalOperatorPhrase(
        self, ctx: cqlParser.ConcurrentWithIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#concurrentWithIntervalOperatorPhrase.
    def exitConcurrentWithIntervalOperatorPhrase(
        self, ctx: cqlParser.ConcurrentWithIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#includesIntervalOperatorPhrase.
    def enterIncludesIntervalOperatorPhrase(
        self, ctx: cqlParser.IncludesIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#includesIntervalOperatorPhrase.
    def exitIncludesIntervalOperatorPhrase(
        self, ctx: cqlParser.IncludesIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#includedInIntervalOperatorPhrase.
    def enterIncludedInIntervalOperatorPhrase(
        self, ctx: cqlParser.IncludedInIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#includedInIntervalOperatorPhrase.
    def exitIncludedInIntervalOperatorPhrase(
        self, ctx: cqlParser.IncludedInIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#beforeOrAfterIntervalOperatorPhrase.
    def enterBeforeOrAfterIntervalOperatorPhrase(
        self, ctx: cqlParser.BeforeOrAfterIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#beforeOrAfterIntervalOperatorPhrase.
    def exitBeforeOrAfterIntervalOperatorPhrase(
        self, ctx: cqlParser.BeforeOrAfterIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#withinIntervalOperatorPhrase.
    def enterWithinIntervalOperatorPhrase(
        self, ctx: cqlParser.WithinIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#withinIntervalOperatorPhrase.
    def exitWithinIntervalOperatorPhrase(
        self, ctx: cqlParser.WithinIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#meetsIntervalOperatorPhrase.
    def enterMeetsIntervalOperatorPhrase(
        self, ctx: cqlParser.MeetsIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#meetsIntervalOperatorPhrase.
    def exitMeetsIntervalOperatorPhrase(
        self, ctx: cqlParser.MeetsIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#overlapsIntervalOperatorPhrase.
    def enterOverlapsIntervalOperatorPhrase(
        self, ctx: cqlParser.OverlapsIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#overlapsIntervalOperatorPhrase.
    def exitOverlapsIntervalOperatorPhrase(
        self, ctx: cqlParser.OverlapsIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#startsIntervalOperatorPhrase.
    def enterStartsIntervalOperatorPhrase(
        self, ctx: cqlParser.StartsIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#startsIntervalOperatorPhrase.
    def exitStartsIntervalOperatorPhrase(
        self, ctx: cqlParser.StartsIntervalOperatorPhraseContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#endsIntervalOperatorPhrase.
    def enterEndsIntervalOperatorPhrase(
        self, ctx: cqlParser.EndsIntervalOperatorPhraseContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#endsIntervalOperatorPhrase.
    def exitEndsIntervalOperatorPhrase(
        self, ctx: cqlParser.EndsIntervalOperatorPhraseContext
    ):
        pass
    ...
    def enterQualifiedMemberInvocation(
        self, ctx: cqlParser.QualifiedMemberInvocationContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#qualifiedMemberInvocation.
    def exitQualifiedMemberInvocation(
        self, ctx: cqlParser.QualifiedMemberInvocationContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#qualifiedFunctionInvocation.
    def enterQualifiedFunctionInvocation(
        self, ctx: cqlParser.QualifiedFunctionInvocationContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#qualifiedFunctionInvocation.
    def exitQualifiedFunctionInvocation(
        self, ctx: cqlParser.QualifiedFunctionInvocationContext
    ):
        pass
    ...
    def enterInstanceElementSelector(
        self, ctx: cqlParser.InstanceElementSelectorContext
    ):
        pass
    ...
    def enterReferentialOrTypeNameIdentifier(
        self, ctx: cqlParser.ReferentialOrTypeNameIdentifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#referentialOrTypeNameIdentifier.
    def exitReferentialOrTypeNameIdentifier(
        self, ctx: cqlParser.ReferentialOrTypeNameIdentifierContext
    ):
        pass

    # Enter a parse tree produced by cqlParser#identifierOrFunctionIdentifier.
    def enterIdentifierOrFunctionIdentifier(
        self, ctx: cqlParser.IdentifierOrFunctionIdentifierContext
    ):
        pass

    # Exit a parse tree produced by cqlParser#identifierOrFunctionIdentifier.
    def exitIdentifierOrFunctionIdentifier(
        self, ctx: cqlParser.IdentifierOrFunctionIdentifierContext
    ):
        pass
